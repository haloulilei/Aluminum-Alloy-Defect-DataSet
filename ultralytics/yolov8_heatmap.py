...
def get_params():
    params = {
        'weight': r'H:\ultralytics10.24_1\runs\detect\train213\weights\best.pt',
        'cfg': r'H:\ultralytics10.24_1\ultralytics\cfg\models\v8\yolov8-C2f-LSKA.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'H:/coco128/coco128/train/images/100.jpg','result')